...
document class Beamer. Unlike in -- for example -- LibreOffice, the content on your
slides is not positioned at the top but in the center of the slide in Beamer by
default.

If you would like to change the default positioning to top alignment you can <a
href="modifytemplate.html" target="_blank">modify the Beamer output template</a>. The first line in this template is something like this: 
