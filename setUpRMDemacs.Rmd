...
```
(setq load-path
      (append '("/path/to/polymode/repository/"  "/path/to/polymode/repository/modes")
              load-path))
...
href="https://raw.githubusercontent.com/m-Py/m-Py.github.io/master/.emacs"
target="_blank">`.emacs` </a>file. Feel free to use any of it if you like.
