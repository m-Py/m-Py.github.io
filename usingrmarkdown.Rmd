...
system (14.04 +) without the requirement of an RStudio installation, which is
...
- If you are using a 64-Bit system, check this link and install the debian package
  (and then skip to **5) ImageMagick**)
