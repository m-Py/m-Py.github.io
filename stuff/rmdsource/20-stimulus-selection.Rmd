...
min-max-anticlustering[^minmax]---simultaneously maximizing 
differerences in independent variables while minizimizing differences 
...
The `LexOPS` package was faster for this large data set ($N$ = 29783) 
than the `anticlust` package (< 1 sec vs. about 1 min on my PC). For the 
remaining two examples, running time is negligible.
