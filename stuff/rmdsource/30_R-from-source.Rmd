...
Interestingly, Java is also necessary to build R from source:
...
# Unexpected dependencies for checking packages 

Most occur when R CMD check tries to build the documentation in pdf format using 
Latex. The following packages are for example needed:
...
Cairo (for images in vignettes), via 
