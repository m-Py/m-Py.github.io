...
As discussed [here](05_setUpRMDemacs.html), I prefer hard line breaks as opposed 
to soft breaks. Any text editor I use for writing R Markdown should include 
functionality for hard line breaks. Fortunately, Kate does. However, we first 
have to define a custom shortcut for this functionality. o insert 
hard line wraps, as emacs does.
