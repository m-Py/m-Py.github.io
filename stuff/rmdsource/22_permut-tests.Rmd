...
*Update on December 17, 2019: I now found out that the special case of equal 
sample sizes has indeed been recognized in the statistical literature (Phipson & 
Smyth, 2010), but since it seems that the issue still has not been appreciated 
everywhere (e.g., Craig & Fisher, 2019).
