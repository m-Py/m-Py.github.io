...
EDIT 2019-12-17: I now found out that the special case of equal sample 
sizes has indeed been treated in the statistical literature (Phipson & 
Smyth, 2010), but since it seems that the issue still has not been 
considered widely (e.g., Craig & Fisher, 2019).
