...
This is how to use Ctags in the awesome KDE text editor 
...
Just add the following lines to a file `.ctags` is your home directory. 
...
R packages. However, I still have to find out if Ctags can be enabled in the R 
environment [rkward](https://rkward.kde.org), that uses kate as its editor.
