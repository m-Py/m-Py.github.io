...
As an example, lets assume we have collected lots of data, e.g., 1,000 
normally distributed observations for two independent groups:
...
observations, we compute the sum and the difference, and across all 
